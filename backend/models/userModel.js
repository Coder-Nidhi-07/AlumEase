...
const userSchema = new mongoose.Schema(
  {
    ...
    // 🔹 Alumni profile fields (used by your React form)
    contact: { type: String, default: "" }, // you can reuse phone if you want
...
// ❌ was: mongoose.model.user
// ✅ should be: mongoose.models.user
const userModel =
